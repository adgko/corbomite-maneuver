...
public class HammerBehavior implements CombatBehavior {
	...
	public void fight(int pelea, JTextField jtextfield) {
		...
		if(resultado==20) {
			...
			System.out.printf("el personaje se hace "+Float.toString(dado.tirarDado(12))+"daños");
			jtextfield.setText("pifia en el ataque. recibe "+Float.toString(dado.tirarDado(10))+" daños");
		}
		else if(resultado==1) {
			System.out.printf("golpe crítico");
			System.out.printf("el personaje hace "+Float.toString(2*(dado.tirarDado(12)))+"daños");
			jtextfield.setText("GOLPE CRÍTICO. hace "+Float.toString(2*(dado.tirarDado(12)))+" daños");
		}
		else if(resultado<pelea) {
			System.out.printf("acierta. hace "+Float.toString(dado.tirarDado(12))+" daño");
			jtextfield.setText("acierta. hace "+Float.toString(dado.tirarDado(12))+" daños");
		}
