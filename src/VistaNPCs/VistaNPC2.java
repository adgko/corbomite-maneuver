...
public class VistaNPC2 {
	...
	public VistaNPC2() {
		...
		name.setText(VistaMain.getNpc2().getNombre());
		sex.setText(VistaMain.getNpc2().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc2().getArma());
		ability.setText(Float.toString(VistaMain.getNpc2().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc2().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc2().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc2().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc2().setNombre(name.getText());
	        	 VistaMain.getNpc2().setCategoría(category.getText());
	        	 VistaMain.getNpc2().setArma(weapon.getText());
	        	 VistaMain.getNpc2().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc2().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc2().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc2().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc2().setNombre("noname");
	        	 VistaMain.getNpc2().setCategoría("guerrero");
	        	 VistaMain.getNpc2().setArma("noweapon");
	        	 VistaMain.getNpc2().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc2().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc2().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc2().setSalud(Integer.parseInt("20"));
	         }
		});
