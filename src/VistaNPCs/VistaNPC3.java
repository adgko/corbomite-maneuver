...
public class VistaNPC3 {
	...
	public VistaNPC3() {
		...
		name.setText(VistaMain.getNpc3().getNombre());
		sex.setText(VistaMain.getNpc3().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc3().getArma());
		ability.setText(Float.toString(VistaMain.getNpc3().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc3().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc3().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc3().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc3().setNombre(name.getText());
	        	 VistaMain.getNpc3().setCategoría(category.getText());
	        	 VistaMain.getNpc3().setArma(weapon.getText());
	        	 VistaMain.getNpc3().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc3().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc3().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc3().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc3().setNombre("noname");
	        	 VistaMain.getNpc3().setCategoría("guerrero");
	        	 VistaMain.getNpc3().setArma("noweapon");
	        	 VistaMain.getNpc3().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc3().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc3().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc3().setSalud(Integer.parseInt("20"));
	         }
		});
