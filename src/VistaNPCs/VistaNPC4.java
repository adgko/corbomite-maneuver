...
public class VistaNPC4 {
	...
	public VistaNPC4() {
		...
		name.setText(VistaMain.getNpc4().getNombre());
		sex.setText(VistaMain.getNpc4().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc4().getArma());
		ability.setText(Float.toString(VistaMain.getNpc4().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc4().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc4().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc4().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc4().setNombre(name.getText());
	        	 VistaMain.getNpc4().setCategoría(category.getText());
	        	 VistaMain.getNpc4().setArma(weapon.getText());
	        	 VistaMain.getNpc4().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc4().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc4().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc4().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc4().setNombre("noname");
	        	 VistaMain.getNpc4().setCategoría("guerrero");
	        	 VistaMain.getNpc4().setArma("noweapon");
	        	 VistaMain.getNpc4().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc4().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc4().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc4().setSalud(Integer.parseInt("20"));
	         }
		});
