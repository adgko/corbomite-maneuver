...
public class VistaNPC8 {
	...
	public VistaNPC8() {
		...
		name.setText(VistaMain.getNpc8().getNombre());
		sex.setText(VistaMain.getNpc8().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc8().getArma());
		ability.setText(Float.toString(VistaMain.getNpc8().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc8().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc8().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc8().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc8().setNombre(name.getText());
	        	 VistaMain.getNpc8().setCategoría(category.getText());
	        	 VistaMain.getNpc8().setArma(weapon.getText());
	        	 VistaMain.getNpc8().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc8().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc8().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc8().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc8().setNombre("noname");
	        	 VistaMain.getNpc8().setCategoría("guerrero");
	        	 VistaMain.getNpc8().setArma("noweapon");
	        	 VistaMain.getNpc8().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc8().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc8().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc8().setSalud(Integer.parseInt("0"));
	         }
		});
