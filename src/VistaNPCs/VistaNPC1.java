...
public class VistaNPC1 {
	...
	public VistaNPC1() {
		...
		name.setText(VistaMain.getNpc1().getNombre());
		sex.setText(VistaMain.getNpc1().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc1().getArma());
		ability.setText(Float.toString(VistaMain.getNpc1().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc1().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc1().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc1().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc1().setNombre(name.getText());
	        	 VistaMain.getNpc1().setCategoría(category.getText());
	        	 VistaMain.getNpc1().setArma(weapon.getText());
	        	 VistaMain.getNpc1().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc1().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc1().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc1().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc1().setNombre("noname");
	        	 VistaMain.getNpc1().setCategoría("guerrero");
	        	 VistaMain.getNpc1().setArma("noweapon");
	        	 VistaMain.getNpc1().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc1().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc1().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc1().setSalud(Integer.parseInt("20"));
	         }
		});
