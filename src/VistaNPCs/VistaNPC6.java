...
public class VistaNPC6 {
	...
	public VistaNPC6() {
		...
		name.setText(VistaMain.getNpc6().getNombre());
		sex.setText(VistaMain.getNpc6().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc6().getArma());
		ability.setText(Float.toString(VistaMain.getNpc6().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc6().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc6().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc6().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc6().setNombre(name.getText());
	        	 VistaMain.getNpc6().setCategoría(category.getText());
	        	 VistaMain.getNpc6().setArma(weapon.getText());
	        	 VistaMain.getNpc6().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc6().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc6().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc6().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc6().setNombre("noname");
	        	 VistaMain.getNpc6().setCategoría("guerrero");
	        	 VistaMain.getNpc6().setArma("noweapon");
	        	 VistaMain.getNpc6().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc6().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc6().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc6().setSalud(Integer.parseInt("0"));
	         }
		});
