...
public class VistaNPC7 {
	...
	public VistaNPC7() {
		...
		name.setText(VistaMain.getNpc7().getNombre());
		sex.setText(VistaMain.getNpc7().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc7().getArma());
		ability.setText(Float.toString(VistaMain.getNpc7().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc7().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc7().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc7().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc7().setNombre(name.getText());
	        	 VistaMain.getNpc7().setCategoría(category.getText());
	        	 VistaMain.getNpc7().setArma(weapon.getText());
	        	 VistaMain.getNpc7().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc7().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc7().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc7().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc7().setNombre("noname");
	        	 VistaMain.getNpc7().setCategoría("guerrero");
	        	 VistaMain.getNpc7().setArma("noweapon");
	        	 VistaMain.getNpc7().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc7().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc7().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc7().setSalud(Integer.parseInt("0"));
	         }
		});
