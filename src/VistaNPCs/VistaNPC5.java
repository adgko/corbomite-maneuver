...
public class VistaNPC5 {
	...
	public VistaNPC5() {
		...
		name.setText(VistaMain.getNpc5().getNombre());
		sex.setText(VistaMain.getNpc5().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getNpc5().getArma());
		ability.setText(Float.toString(VistaMain.getNpc5().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getNpc5().getPelea()));
		clever.setText(Float.toString(VistaMain.getNpc5().getAstucia()));
		health.setText(Float.toString(VistaMain.getNpc5().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getNpc5().setNombre(name.getText());
	        	 VistaMain.getNpc5().setCategoría(category.getText());
	        	 VistaMain.getNpc5().setArma(weapon.getText());
	        	 VistaMain.getNpc5().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getNpc5().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getNpc5().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getNpc5().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getNpc5().setNombre("noname");
	        	 VistaMain.getNpc5().setCategoría("guerrero");
	        	 VistaMain.getNpc5().setArma("noweapon");
	        	 VistaMain.getNpc5().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getNpc5().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getNpc5().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getNpc5().setSalud(Integer.parseInt("0"));
	         }
		});
