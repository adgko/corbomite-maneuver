...
public class VistaGuerrero2 {
	...
	public VistaGuerrero2() {
		...
		name.setText(VistaMain.getGuerrero2().getNombre());
		sex.setText(VistaMain.getGuerrero2().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getGuerrero2().getArma());
		ability.setText(Float.toString(VistaMain.getGuerrero2().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getGuerrero2().getPelea()));
		clever.setText(Float.toString(VistaMain.getGuerrero2().getAstucia()));
		health.setText(Float.toString(VistaMain.getGuerrero2().getSalud()));
		...
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 ...
	        	 VistaMain.getGuerrero2().setNombre(name.getText());
	        	 VistaMain.getGuerrero2().setCategoría(category.getText());
	        	 VistaMain.getGuerrero2().setArma(weapon.getText());
	        	 VistaMain.getGuerrero2().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getGuerrero2().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getGuerrero2().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getGuerrero2().setSalud(Integer.parseInt(health.getText()));
	         }
		});/*
		...
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getGuerrero2().setNombre("noname");
	        	 VistaMain.getGuerrero2().setCategoría("guerrero");
	        	 VistaMain.getGuerrero2().setArma("noweapon");
	        	 VistaMain.getGuerrero2().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getGuerrero2().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getGuerrero2().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getGuerrero2().setSalud(Integer.parseInt("20"));
	         }
		});
