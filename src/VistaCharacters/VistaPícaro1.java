...
public class VistaPícaro1 {
	...
	public VistaPícaro1() {
		...
		name.setText(VistaMain.getPícaro1().getNombre());
		sex.setText(VistaMain.getPícaro1().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getPícaro1().getArma());
		ability.setText(Float.toString(VistaMain.getPícaro1().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getPícaro1().getPelea()));
		clever.setText(Float.toString(VistaMain.getPícaro1().getAstucia()));
		health.setText(Float.toString(VistaMain.getPícaro1().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getPícaro1().setNombre(name.getText());
	        	 VistaMain.getPícaro1().setCategoría(category.getText());
	        	 VistaMain.getPícaro1().setArma(weapon.getText());
	        	 VistaMain.getPícaro1().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getPícaro1().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getPícaro1().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getPícaro1().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getPícaro1().setNombre("noname");
	        	 VistaMain.getPícaro1().setCategoría("guerrero");
	        	 VistaMain.getPícaro1().setArma("noweapon");
	        	 VistaMain.getPícaro1().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getPícaro1().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getPícaro1().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getPícaro1().setSalud(Integer.parseInt("20"));
	         }
		});
