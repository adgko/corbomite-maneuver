...
public class VistaMago1 {
	...
	public VistaMago1() {
		...
		name.setText(VistaMain.getMago1().getNombre());
		sex.setText(VistaMain.getMago1().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getMago1().getArma());
		ability.setText(Float.toString(VistaMain.getMago1().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getMago1().getPelea()));
		clever.setText(Float.toString(VistaMain.getMago1().getAstucia()));
		health.setText(Float.toString(VistaMain.getMago1().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getMago1().setNombre(name.getText());
	        	 VistaMain.getMago1().setCategoría(category.getText());
	        	 VistaMain.getMago1().setArma(weapon.getText());
	        	 VistaMain.getMago1().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getMago1().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getMago1().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getMago1().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getMago1().setNombre("noname");
	        	 VistaMain.getMago1().setCategoría("guerrero");
	        	 VistaMain.getMago1().setArma("noweapon");
	        	 VistaMain.getMago1().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getMago1().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getMago1().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getMago1().setSalud(Integer.parseInt("20"));
	         }
		});
