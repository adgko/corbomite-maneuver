...
public class VistaAventurero2 {
	...
	public VistaAventurero2() {
		...
		name.setText(VistaMain.getAventurero2().getNombre());
		sex.setText(VistaMain.getAventurero2().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getAventurero2().getArma());
		ability.setText(Float.toString(VistaMain.getAventurero2().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getAventurero2().getPelea()));
		clever.setText(Float.toString(VistaMain.getAventurero2().getAstucia()));
		health.setText(Float.toString(VistaMain.getAventurero2().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getAventurero2().setNombre(name.getText());
	        	 VistaMain.getAventurero2().setCategoría(category.getText());
	        	 VistaMain.getAventurero2().setArma(weapon.getText());
	        	 VistaMain.getAventurero2().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getAventurero2().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getAventurero2().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getAventurero2().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getAventurero2().setNombre("noname");
	        	 VistaMain.getAventurero2().setCategoría("guerrero");
	        	 VistaMain.getAventurero2().setArma("noweapon");
	        	 VistaMain.getAventurero2().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getAventurero2().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getAventurero2().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getAventurero2().setSalud(Integer.parseInt("20"));
	         }
		});
