...
public class VistaAventurero1 {
	...
	public VistaAventurero1() {
		...
		name.setText(VistaMain.getAventurero1().getNombre());
		sex.setText(VistaMain.getAventurero1().getSexo());
		category.setText("categoría");
		weapon.setText(VistaMain.getAventurero1().getArma());
		ability.setText(Float.toString(VistaMain.getAventurero1().getHabilidad()));
		fight.setText(Float.toString(VistaMain.getAventurero1().getPelea()));
		clever.setText(Float.toString(VistaMain.getAventurero1().getAstucia()));
		health.setText(Float.toString(VistaMain.getAventurero1().getSalud()));
		
		crear.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 
	        	 VistaMain.getAventurero1().setNombre(name.getText());
	        	 VistaMain.getAventurero1().setCategoría(category.getText());
	        	 VistaMain.getAventurero1().setArma(weapon.getText());
	        	 VistaMain.getAventurero1().setHabilidad(Integer.parseInt(ability.getText()));
	        	 VistaMain.getAventurero1().setPelea(Integer.parseInt(fight.getText()));
	        	 VistaMain.getAventurero1().setAstucia(Integer.parseInt(clever.getText()));
	        	 VistaMain.getAventurero1().setSalud(Integer.parseInt(health.getText()));
	         }
		});
		borrar.addActionListener(new ActionListener(){
	         public void actionPerformed(ActionEvent e){
	        	 VistaMain.getAventurero1().setNombre("noname");
	        	 VistaMain.getAventurero1().setCategoría("guerrero");
	        	 VistaMain.getAventurero1().setArma("noweapon");
	        	 VistaMain.getAventurero1().setHabilidad(Integer.parseInt("0"));
	        	 VistaMain.getAventurero1().setPelea(Integer.parseInt("0"));
	        	 VistaMain.getAventurero1().setAstucia(Integer.parseInt("0"));
	        	 VistaMain.getAventurero1().setSalud(Integer.parseInt("20"));
	         }
		});
